...
OTRGlobals::OTRGlobals() {
    ...
    loader->RegisterResourceFactory(std::make_shared<SOH::ResourceFactoryBinaryJsonV0>(), RESOURCE_FORMAT_JSON, "Text", static_cast<uint32_t>(SOH::ResourceType::SOH_Text), 0);
